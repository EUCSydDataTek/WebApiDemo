/* Ensure that the AccountNumber consists of three parts with different lengths (3, 10, and 2). 
 * Also, we want to ensure that those parts are divided by the minus sign separator. */
