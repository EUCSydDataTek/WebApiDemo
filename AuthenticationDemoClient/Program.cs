...
var request = new HttpRequestMessage(HttpMethod.Post, "https://localhost:7280/account/login");
...
request = new HttpRequestMessage(HttpMethod.Get, "https://localhost:7280/WeatherForecast");
